    					...
    					if(!(fluNum.equals(""))){
    						...
    						try{
    							...
    							Map<String , String> map = db.selectOneRecord("TBL_FlOW", DbInfoImpl.FieldNames[1] , "SYS_TRACE_AUDIT_NUM = ?"
    									, new String[]{fluNum}, null, null, null);
    							...
    							if(map != null && map.size() != 0){
    							    ...
    							    purchaseBill.setPrepayCardName(map.get("RESERVED_PRIVATE3_1"));     //预付卡名称      RESERVED_PRIVATE3
    						    ...
    						    /*-----------demo data-----------*/
    						    PrinterHelper.getInstance().printerPurchaseBill(purchaseBill);
    						}catch(Exception ex){
    							ex.printStackTrace();
    						}
