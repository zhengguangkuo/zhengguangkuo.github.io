				...
				if (respcode.equals("00")) {// 响应成功
					...
					if(key.length() == 150){
						...
						for(String keyBea1 : keysArray){
							if(keyBea1.substring(0, 2).equals("00")){
								...
								String TMK_appear1 = DES.DES_3(TMK.substring(0, 16), readM.get("cdkey"), 1);  //得到明文
								String TMK_appear2 = DES.DES_3(TMK.substring(16, 32), readM.get("cdkey"), 1);
								String TMK_appear = TMK_appear1 + TMK_appear2;
								String jiaoyan_tmk = DES.DES_3("0000000000000000", TMK_appear, 0);
								if(jiaoyan_tmk.equals(tCheck)){  //校验成功
									byte[] arryOldMasterKey = new byte[]{(byte)0x38 ,(byte)0x38 ,(byte)0x38 ,(byte)0x38
											...
											,(byte)0x38 ,(byte)0x38 ,(byte)0x38 ,(byte)0x38
											,(byte)0x38 ,(byte)0x38 ,(byte)0x38 ,(byte)0x38};
									//byte[] arryOldMasterKey = StrUtil.HexStringToByte("75572610D0A8B3804934B0E0670E643B", "");
