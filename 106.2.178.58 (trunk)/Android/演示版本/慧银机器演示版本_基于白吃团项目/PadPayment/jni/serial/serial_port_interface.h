 ...
 * 				  >= 0 : file description
 */
typedef int (*serial_port_open)(char* pDeviceName);
 ...
 * 				  >=0 : success
 */
typedef int (*serial_port_close)(int fd);
 ...
 * 				  >= 0 : data length
 */
typedef int (*serial_port_read)(int fd, unsigned char* pDataBuffer, int nExpectedDataLength, int nTimeout_MS);
 ...
 */
typedef int (*serial_port_write)(int fd, unsigned char* pDataBuffer, int nDataLength);
 ...
 * 				  >= 0 :
 */
typedef int (*serial_port_set_baudrate)(int fd, unsigned int nBaudrate);
 ...
 * 				  >= 0 :
 */
typedef int (*serial_port_flush_io)(int fd);
