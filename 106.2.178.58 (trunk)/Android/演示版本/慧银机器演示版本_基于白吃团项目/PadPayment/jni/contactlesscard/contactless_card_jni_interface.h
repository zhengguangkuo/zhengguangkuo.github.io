...
jint JNICALL native_contactless_card_15693_read(JNIEnv *, jclass , jint , jint, jbyteArray, jint);
jint JNICALL native_contactless_card_15693_write(JNIEnv *, jclass  , jint, jbyteArray, jint);
