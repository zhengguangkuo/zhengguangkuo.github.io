...
public final class CommandID extends BaseCommandID {
	...
	public void registerCommand() {
		...
		map.put("ToPrintCommand", CommandExecutor.IDistributer());//打印菜单
		map.put("TO_REGISTER",CommandExecutor.IDistributer());//跳转到注册
		map.put("REGISTER_RESULT", CommandExecutor.IDistributer());//跳转到注册结果
	}
