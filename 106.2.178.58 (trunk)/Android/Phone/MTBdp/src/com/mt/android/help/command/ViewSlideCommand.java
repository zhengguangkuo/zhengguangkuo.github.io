...
public class ViewSlideCommand extends AbstractCommand{
private static Logger log = Logger.getLogger(ViewSlideCommand.class);
	...
	protected void onAfterExecute()
	{
		...
		response.setTargetActivityID(BaseActivityID.map.get("ACTIVITY_ID_VIEW_SLIDE"));
