...
public class Package_SelectActivity extends BaseActivity {
	/** 第一次发送订购短信 */
	...
	private Button onoff, selectpackage;
	...
	Runnable runnable = new Runnable() {
		public void run() {
			mDialog.dismiss();
			show = true;
			Toast.makeText(Package_SelectActivity.this, "接收短信超时，请注意查看短信", 3000).show();
		}
	};
	...
	private final String TAG_LOG = Package_SelectActivity.class.getSimpleName();
	...
	protected void onCreateContent(Bundle savedInstanceState) {
		...
		listview = (ListView) findViewById(R.id.smlistview);
		onoff = (Button) findViewById(R.id.onoff);
		title.setText("套餐选择");
		selectpackage = (Button) findViewById(R.id.packageaction);
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				case HANDLER_FIRST_SMS_ERROR :			// 订购短信发送失败
					...
					Toast.makeText(Package_SelectActivity.this, "短信发送失败，请重新操作...", 0) ;
					break;
		...
		listview.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				Log.i("=====position===", arg2 + "");
				AlertDialog.Builder builder = new Builder(Package_SelectActivity.this);
		...
		selectpackage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (clickPosition == -1) {
					showToast(Package_SelectActivity.this, "请先选择您要订制的套餐");
				} else {
					AlertDialog.Builder builder = new Builder(Package_SelectActivity.this);
					if (isBind) {
					...
					builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							try {
								...
								showToast(Package_SelectActivity.this, "短信发送失败！");
							}
		...
		/*Intent intent = new Intent(Package_SelectActivity.this, InterceptService.class);
			...
			if (bundle != null) {
				...
				for (SmsMessage msg : messages) {
					...
					if (sender.contains(phoneNumber)) {
						...
						/*
						 * Intent intent2 = new Intent(MyService.this,
						 * MainActivity.class) ;
	...
	/*public void ShowDialog(final int flag, String str) {
		AlertDialog.Builder builder = new AlertDialog.Builder(Package_SelectActivity.this);
...
//				Toast.makeText(Package_SelectActivity.this, ((ResponseBean) response.getData()).getMessage(), Toast.LENGTH_SHORT).show();
			}
