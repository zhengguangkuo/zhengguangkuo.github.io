...
public class EleDiscountQueryCommand extends AbstractCommand {

	private static Logger log = Logger.getLogger(EleDiscountQueryCommand.class);
	...
	protected void go() {
		try {
			...
			List<ResponseBean> list = DispatchRequest.doHttpRequest(
					Constants.USR_OBTAIN_DIS_QUERY, getRequest(),
					ObtainDisResult.class);
			if (list != null && list.size() > 0) {
				...
				ObtainDisResult result = (ObtainDisResult)list.get(0);
