...
public class App_ManagequeryCommand extends AbstractCommand {
	private static Logger log = Logger.getLogger(App_ManagequeryCommand.class);
	...
	protected void go() {
		...
		try {
			...
			List<ResponseBean> list = DispatchRequest.doHttpRequest(
					Constants.USR_CARD_APP_QUERY, getRequest(),
