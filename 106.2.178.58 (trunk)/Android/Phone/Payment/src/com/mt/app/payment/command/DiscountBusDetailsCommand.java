...
public class DiscountBusDetailsCommand extends AbstractCommand {

	private static Logger log = Logger.getLogger(DiscountBusDetailsCommand.class);
	...
	protected void go() {
		try {
			...
			List<ResponseBean> list = DispatchRequest.doHttpRequest(
					Constants.USR_SALE_DETAILS, getRequest(),
