...
public class RegCodeGetCommand extends AbstractCommand{
	private static Logger log = Logger.getLogger(RegCodeGetCommand.class);
    ...
    protected void go() {
			...
			try {
				...
				List<ResponseBean> list = DispatchRequest.doHttpRequest(
						Constants.USR_GET_VERIFY, getRequest(),
