 ...
 */
public class GuideBaseCard_SelectCommand extends AbstractCommand {
	private static Logger log = Logger.getLogger(GuideBaseCard_SelectCommand.class);
	...
	protected void onAfterExecute() {
		...
		{	
			...
			response.setTargetActivityID(ActivityID.map
					.get("ACTIVITY_ID_GuideBaseCardSelect"));
		}
