 ...
 * @Description:按条件搜索优惠券列表

 * @author:dw

 * @time:2013-9-10 下午5:05:04
 */
public class DiscountDisSearchCommand extends AbstractCommand {

	private static Logger log = Logger.getLogger(DiscountDisSearchCommand.class);
	...
	protected void go() {
		try {
			...
			List<ResponseBean> list = DispatchRequest.doHttpRequest(
					Constants.USR_COUPONS_SEARCH, getRequest(),  //优惠券搜索
