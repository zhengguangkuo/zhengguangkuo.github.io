 ...
 */
public class BaseCardSelectTwoCommand extends AbstractCommand {

	private static Logger log = Logger.getLogger(BaseCardSelectTwoCommand.class);
