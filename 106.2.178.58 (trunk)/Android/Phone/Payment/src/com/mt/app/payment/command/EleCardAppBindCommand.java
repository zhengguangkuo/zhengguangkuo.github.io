...
public class EleCardAppBindCommand extends AbstractCommand {

	private static Logger log = Logger.getLogger(EleCardAppBindCommand.class);
	...
	protected void go() {
		try {
			...
			response.setBussinessType("appBind");
