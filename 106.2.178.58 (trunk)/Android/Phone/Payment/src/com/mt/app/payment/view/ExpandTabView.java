...
public class ExpandTabView extends LinearLayout implements OnDismissListener {
	...
	public static List<PopupWindow> popLists  = new ArrayList<PopupWindow>();
	...
	private void closed() {
		try {
			...
			ExpandTabView et1 = ((TabDiscount_01_MainListActivity) mContext).expandTabView;
			
				if (et1.popupWindow.isShowing()) {
					et1.selectedButton.setChecked(false);
					et1.popupWindow.dismiss();
					et1.hideView();
			}
		...
		try{
			ExpandTabView et2 = ((TabDiscount_01_MainListActivity) mContext).expandTabView2;
				if (et2.popupWindow.isShowing()) {
					et2.selectedButton.setChecked(false);
					et2.popupWindow.dismiss();
					et2.hideView();
				}
