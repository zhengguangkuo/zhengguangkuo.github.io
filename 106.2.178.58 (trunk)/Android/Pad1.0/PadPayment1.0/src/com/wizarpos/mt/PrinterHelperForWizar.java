...
public class PrinterHelperForWizar extends PrinterDriver 
{
	   /* 等待打印缓冲刷新的时间 */
    private static final int PRINTER_BUFFER_FLUSH_WAITTIME = /*300*/150;

    private static PrinterHelperForWizar _instance;

    static {
  		System.loadLibrary("wizarpos_printer");
  	}
    
    private PrinterHelperForWizar() 
    {
    }

  
    
    synchronized public static PrinterHelperForWizar getInstance() 
    {
		if (null == _instance)
    		_instance = new PrinterHelperForWizar();
		return _instance;
    }
