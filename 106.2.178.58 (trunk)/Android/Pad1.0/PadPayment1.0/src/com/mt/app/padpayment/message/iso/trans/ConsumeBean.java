 ...
 * @time:2013-7-16 下午7:26:03
 */
public class ConsumeBean extends MessageBody {
	
	@MsgDirection(direction = "response")
	private String cardNo = ""; // 支付卡卡号
	...
	@MsgDirection(direction = "response")
	private String  localTransDate = ""; //受卡方所在地日期
	...
	@MsgDirection(direction = "response")
	private String balanceAmount = ""; //附加金额54
	...
	@MsgDirection(direction = "double")
	private String couponsAdvertId = ""; //发券标识
