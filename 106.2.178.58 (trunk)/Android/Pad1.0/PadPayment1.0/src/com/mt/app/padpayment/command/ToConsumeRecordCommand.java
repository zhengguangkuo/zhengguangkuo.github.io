...
public class ToConsumeRecordCommand extends AbstractCommand {
	private static Logger log = Logger.getLogger(ToConsumeRecordCommand.class);
	...
	protected void go() {
		...
		response.setTargetActivityID(ActivityID.map.get("ACTIVITY_ID_NoteConsumeActivity"));
