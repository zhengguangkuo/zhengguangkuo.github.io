...
//    [_businessIV setImageWithURL:[NSURL URLWithString:_businessImageURL] placeholderImage:[UIImage imageNamed:@"load.png"]];
...
//    UIImage *image = [UIImage OriginImage:businessLogo.image scaleToSize:CGSizeMake(310,130)];
//    _businessIV.image = image;
