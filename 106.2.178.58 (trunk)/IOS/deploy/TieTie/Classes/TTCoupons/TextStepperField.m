...
- (void)initializeControl {
    ...
    [self.minusButton setBackgroundImage:[[UIImage imageNamed:@"n_cut_normal.png"] resizableImageWithCapInsets:insetButtonImage] forState:UIControlStateNormal];
    [self.minusButton setBackgroundImage:[[UIImage imageNamed:@"n_cut_selected.png"] resizableImageWithCapInsets:insetButtonImage]forState:UIControlStateHighlighted];
    [self.minusButton setBackgroundImage:[UIImage imageNamed:@"n_cut_normal.png"] forState:UIControlStateNormal];
    [self.minusButton setBackgroundImage:[UIImage imageNamed:@"n_cut_selected.png"] forState:UIControlStateHighlighted];
    ...
    [self.plusButton setBackgroundImage:[[UIImage imageNamed:@"n_add_normal.png"]resizableImageWithCapInsets:insetButtonImage] forState:UIControlStateNormal];
    [self.plusButton setBackgroundImage:[[UIImage imageNamed:@"n_aad_selected.png"] resizableImageWithCapInsets:insetButtonImage] forState:UIControlStateHighlighted];
    [self.plusButton setBackgroundImage:[UIImage imageNamed:@"n_add_normal.png"] forState:UIControlStateNormal];
    [self.plusButton setBackgroundImage:[UIImage imageNamed:@"n_aad_selected.png"] forState:UIControlStateHighlighted];
    ...
    [self.textField setBackground:[UIImage imageNamed:@"numbbox.png"]];
