...
- (void)initial
{
    ...
    self.backgroundColor = [UIColor colorWithRed:color green:color blue:color alpha:0.0];
...
- (void)setFrame:(CGRect)frame
{
    ...
    _statusLabel.frame = CGRectMake(statusX, statusY+17, statusWidth, statusHeight);
