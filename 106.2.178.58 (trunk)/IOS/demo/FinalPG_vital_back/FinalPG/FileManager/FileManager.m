...
{
    NSArray* tempArray = [file_name componentsSeparatedByString:@"/"];
    NSString*  strpath = [tempArray lastObject];
    BOOL result = FALSE;
    result = [FileManager isFileExist: strpath];
...
+(NSString*)GetFullPathofFile:(NSString*)file_name
{
    NSArray* tempArray = [file_name componentsSeparatedByString:@"/"];
    NSString*  strpath = [tempArray lastObject];
    return [FileManager dataFilePath: strpath];
}
